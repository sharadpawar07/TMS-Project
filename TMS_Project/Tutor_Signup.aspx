  ...
  <div class="container shadow-box">
          ...
          <div class="row">
                 ...
                 <br />
                  ...
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="MaritalStatusDropDownList" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="Status is Required"></asp:RequiredFieldValidator>
               ...
               <div class="col-md-4">
                    ...
                    <br /> 
                     <asp:DropDownList ID="CityDropDownList" CssClass="form-control" runat="server"></asp:DropDownList>
                      &nbsp;
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator17" InitialValue="Select Country"  ControlToValidate="CityDropDownList" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="City  is Required"></asp:RequiredFieldValidator>
                 <br />
